...
class Database:
    def __init__(self):
        ...
        self.ensure_settings_exist(cursor)
        cursor.close()
    ...
    def ensure_settings_exist(self, cursor):
        defaults = [
            ("CHECK_INTERVAL", "10"),
    ...
    def get_all_wallets(self):
        ...
        try:
            ...
            if self.get_setting("DEBUG") == "1":  # Проверяем без вложенного вызова
    ...
    def add_transaction(self, tx_hash, wallet_address, token_name, usd_value):
        ...
        try:
            ...
            self.conn.commit()
            if self.get_setting("TRANSACTION_INFO") == "1":
    ...
    def add_tracked_token(self, token_name, contract_address, thread_id):
        ...
        try:
            ...
            self.conn.commit()
            if self.get_setting("INTERFACE_INFO") == "1":
    ...
    def get_all_settings(self):
        ...
        try:
            ...
            # Убрано отладочное логирование здесь, чтобы избежать рекурсии
            return settings
        except mysql.connector.Error as e:
